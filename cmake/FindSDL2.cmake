...
if(SDL2_LIBRARY_TEMP)
  ...
  # For MinGW library
  if(MINGW)
    set(SDL2_LIBRARY_TEMP ${SDL2_LIBRARY_TEMP} ${SDL2MAIN_LIBRARY} ${MINGW32_LIBRARY})
  endif()
...
if(MINGW)
  ...
  set(SDL2_LIBRARIES mingw32 ${SDL2_LIBRARY} )
endif(MINGW)

#i don't want to lose this...
# if(MINGW)
#   unset(SDL2_LIBRARIES)
#   string(REGEX MATCH "(.*)/lib/(.*)" source_path "${SDL2MAIN_LIBRARY}")
#   if(source_path)
#     string(REGEX REPLACE "(.*)/lib/(.*)" "\\1" before_source "${source_path}")
#     string(CONCAT libraries_path "${before_source}" "/lib")
#   endif(source_path)
#   set(SDL2_LIBRARIES "${libraries_path}" ${SDL2_LIBRARY})
# endif(MINGW)
